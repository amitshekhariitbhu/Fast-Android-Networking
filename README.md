...
* Recent removal of HttpClient in Android Marshmallow(Android M) made other networking libraries obsolete and of no use.
* No other single library is not rich enough to does each and everything like making request, downloading any type of file, uploading file, loading
